...
public class Lexer {
    ...
    public Token nextToken() {
        ...
        while (this.curr == ' ' || this.curr == '\t' || this.curr == '\r') {
            this.readChar();
        }
        ...
        switch ((char) this.curr) {
            ...
            case '#':
                tok = new Token(TokenList.HASH, this.curr);
                break;

            case '\n':
                tok = new Token(TokenList.NEWLINE, this.curr);
                break;
            case '\t':
                tok = new Token(TokenList.TAB, this.curr);
                break;
            case '\r':
                tok = new Token(TokenList.CARRIEAGERETURN, this.curr);
                break;
            case ' ':
                tok = new Token(TokenList.SPACE, this.curr);
                break;
            case 0:
